...
export type DOWNLOAD_AUDIO = typeof DOWNLOAD_AUDIO;

export const DOWNLOAD_AUDIO_END = "DOWNLOAD_AUDIO_END";
export type DOWNLOAD_AUDIO_END = typeof DOWNLOAD_AUDIO_END;
...
export const downloadAudioAction = createStandardAction(DOWNLOAD_AUDIO)<
  Audio
>();
export const downloadAudioEndAction = createStandardAction(
  DOWNLOAD_AUDIO_END
)();
...
export const deleteAudioAction = createStandardAction(DELETE_AUDIO)<string>();
export const deleteAudioSuccessAction = createStandardAction(
  DELETE_AUDIO_SUCCESS
)<number>();

export const createAudioAction = createStandardAction(CREATE_AUDIO)<
  AudioUpload
>();
...
export type UserActions = ActionType<
  ...
  | typeof downloadAudioAction
  | typeof updateAudioAction
  | typeof updateAudioSuccessAction
  | typeof downloadAudioEndAction
